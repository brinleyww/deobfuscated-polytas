        ...
        6546: (e, t, n) => {
            ...
            const i = e => {
                    const t = e.CapacitorCustomPlatform || null,
                        ...
                        c = new Map;
                    return n.convertFileSrc || (n.convertFileSrc = e => e), n.getPlatform = a, n.handleError = t => e.console.error(t), n.isNativePlatform = () => "web" !== a(), n.isPluginAvailable = e => {
                        const t = c.get(e);
                        return !!(null == t ? void 0 : t.platforms.has(a())) || !!o(e)
                    }, n.registerPlugin = (e, l = {}) => {
                        const d = c.get(e);
                        if (d) return console.warn(`Capacitor plugin "${e}" already registered. Cannot register plugins twice.`), d.proxy;
                        const u = a(),
                            h = o(e);
                        let m;
                        const p = i => {
                                let a;
                                const o = (...o) => {
                                    const c = (async () => (!m && u in l ? m = m = "function" == typeof l[u] ? await l[u]() : l[u] : null !== t && !m && "web" in l && (m = m = "function" == typeof l.web ? await l.web() : l.web), m))().then((t => {
                                        const c = ((t, i) => {
                                            var a, o;
                                            if (!h) {
                                                if (t) return null === (o = t[i]) || void 0 === o ? void 0 : o.bind(t);
                                                throw new r(`"${e}" plugin is not implemented on ${u}`, s.Unimplemented)
                                            } {
                                                const s = null == h ? void 0 : h.methods.find((e => i === e.name));
                                                if (s) return "promise" === s.rtype ? t => n.nativePromise(e, i.toString(), t) : (t, s) => n.nativeCallback(e, i.toString(), t, s);
                                        ...
                                        throw new r(`"${e}.${i}()" is not implemented on ${u}`, s.Unimplemented)
                                    }));
                                    return "addListener" === i && (c.remove = async () => a()), c
                                };
                                return o.toString = () => `${i.toString()}() { [capacitor code] }`, Object.defineProperty(o, "name", {
                                    value: i,
                                    writable: !1,
                                    configurable: !1
                                }), o
                        ...
                        return i[e] = v, c.set(e, {
                            name: e,
                            proxy: v,
                            platforms: new Set([...Object.keys(l), ...h ? [u] : []])
                        }), v
                    }, n.Exception = r, n.DEBUG = !!n.DEBUG, n.isLoggingEnabled = !!n.isLoggingEnabled, n
                },
                a = (e => e.Capacitor = i(e))("undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : void 0 !== n.g ? n.g : {}),
                o = a.registerPlugin;
            class c {
                constructor() {
                ...
                unimplemented(e = "not implemented") {
                    return new a.Exception(e, s.Unimplemented)
                }
                unavailable(e = "not available") {
                    return new a.Exception(e, s.Unavailable)
                }
            ...
            const l = e => encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g, decodeURIComponent).replace(/[()]/g, escape),
            ...
            class u extends c {
                async getCookies() {
                    ...
                    return e.split(";").forEach((e => {
                        ...
                        let [n, s] = e.replace(/=/, "CAP_COOKIE").split("CAP_COOKIE");
                        n = d(n).trim(), s = d(s).trim(), t[n] = s
                    })), t
                }
                async setCookie(e) {
                    try {
                        ...
                        document.cookie = `${t}=${n||""}${s}; path=${r}; ${i};`
                    } catch (e) {
            ...
            const h = (e, t = {}) => {
                const n = Object.assign({
                    ...
                    s = ((e = {}) => {
                        ...
                        return Object.keys(e).map((e => e.toLocaleLowerCase())).reduce(((n, s, r) => (n[s] = e[t[r]], n)), {})
                    })(e.headers)["content-type"] || "";
                if ("string" == typeof e.data) n.body = e.data;
                else if (s.includes("application/x-www-form-urlencoded")) {
                    const t = new URLSearchParams;
                    for (const [n, s] of Object.entries(e.data || {})) t.set(n, s);
                    n.body = t.toString()
                ...
                } else(s.includes("application/json") || "object" == typeof e.data) && (n.body = JSON.stringify(e.data));
                return n
            };
            class m extends c {
                async request(e) {
                    const t = h(e, e.webFetchExtra),
                        n = ((e, t = !0) => e ? Object.entries(e).reduce(((e, n) => {
                            const [s, r] = n;
                            let i, a;
                            return Array.isArray(r) ? (a = "", r.forEach((e => {
                                i = t ? encodeURIComponent(e) : e, a += `${s}=${i}&`
                            })), a.slice(0, -1)) : (i = t ? encodeURIComponent(r) : r, a = `${s}=${i}`), `${e}&${a}`
                    ...
                    switch (i.includes("application/json") && (c = "json"), c) {
                        case "arraybuffer":
                        case "blob":
                            o = await r.blob(), a = await (async e => new Promise(((t, n) => {
                                const s = new FileReader;
                                s.onload = () => {
                                    const e = s.result;
                                    t(e.indexOf(",") >= 0 ? e.split(",")[1] : e)
                                }, s.onerror = e => n(e), s.readAsDataURL(e)
                            })))(o);
                            break;
                        case "json":
                            a = await r.json();
