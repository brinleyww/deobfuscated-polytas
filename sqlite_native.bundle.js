        ...
        1321: (e, t, s) => {
            ...
            class a {
                ...
                async clearEncryptionSecret() {
                    try {
                        return await this.sqlite.clearEncryptionSecret(), Promise.resolve()
                    } catch (e) {
                        return Promise.reject(e)
                    }
                }
                ...
                async addUpgradeStatement(e, t) {
                    try {
                        return e.endsWith(".db") && (e = e.slice(0, -3)), await this.sqlite.addUpgradeStatement({
                            database: e,
                            upgrade: t
                        }), Promise.resolve()
                    } catch (e) {
                ...
                async createConnection(e, t, s, r, a) {
                    try {
                        e.endsWith(".db") && (e = e.slice(0, -3)), await this.sqlite.createConnection({
                            database: e,
                            encrypted: t,
                            mode: s,
                            version: r,
                ...
                async closeConnection(e, t) {
                    try {
                        e.endsWith(".db") && (e = e.slice(0, -3)), await this.sqlite.closeConnection({
                            database: e,
                            readonly: t
                        });
                ...
                async retrieveNCConnection(e) {
                    if (this._connectionDict.has(e)) {
                        ...
                        return void 0 !== s ? Promise.resolve(s) : Promise.reject(`Connection ${e} is undefined`)
                    }
                    return Promise.reject(`Connection ${e} does not exist`)
                }
                ...
                async checkConnectionsConsistency() {
                    try {
                        const e = [...this._connectionDict.keys()],
                            t = [],
                            s = [];
                        for (const r of e) t.push(r.substring(0, 2)), s.push(r.substring(3));
                        const r = await this.sqlite.checkConnectionsConsistency({
                            dbNames: s,
                            openModes: t
                        });
                        return r.result || (this._connectionDict = new Map), Promise.resolve(r)
                    } catch (e) {
            ...
            class n {
                ...
                async execute(e, t = !0, s = !0) {
                    try {
                        if (this.readonly) return Promise.reject("not allowed in read-only mode");
                        {
                ...
                async query(e, t, s = !0) {
                    let r;
                    try {
                        return r = t && t.length > 0 ? await this.sqlite.query({
                            database: this.dbName,
                            statement: e,
                            values: t,
                            readonly: this.readonly,
                            ...
                            readonly: this.readonly,
                            isSQL92: s
                        }), r = await this.reorderRows(r), Promise.resolve(r)
                    } catch (e) {
                        return Promise.reject(e)
                    }
                }
                async run(e, t, s = !0, r = "no", a = !0) {
                    let n;
                    try {
                        return this.readonly ? Promise.reject("not allowed in read-only mode") : (n = t && t.length > 0 ? await this.sqlite.run({
                            database: this.dbName,
                            statement: e,
                            values: t,
                            transaction: s,
                            ...
                            returnMode: r,
                            isSQL92: a
                        }), n.changes = await this.reorderRows(n.changes), Promise.resolve(n))
                    } catch (e) {
                        return Promise.reject(e)
                    }
                }
                async executeSet(e, t = !0, s = "no", r = !0) {
                    let a;
                    try {
                        return this.readonly ? Promise.reject("not allowed in read-only mode") : (a = await this.sqlite.executeSet({
                            database: this.dbName,
                            set: e,
                            transaction: t,
                            readonly: !1,
                            returnMode: s,
                            isSQL92: r
                        }), a.changes = await this.reorderRows(a.changes), Promise.resolve(a))
                    } catch (e) {
                        return Promise.reject(e)
                    }
                }
                ...
                async getSyncDate() {
                    try {
                        ...
                        let t = "";
                        return e.syncDate > 0 && (t = new Date(1e3 * e.syncDate).toISOString()), Promise.resolve(t)
                    } catch (e) {
                        return Promise.reject(e)
                    }
                }
                ...
                async executeTransaction(e, t = !0) {
                    ...
                    if (await this.sqlite.beginTransaction({
                            ...
                            database: this.dbName
                        }), !r) return Promise.reject("After Begin Transaction, no transaction active");
                    try {
                        for (const r of e) {
                            if ("object" != typeof r || !("statement" in r)) throw new Error("Error a task.statement must be provided");
                            if ("values" in r && r.values && r.values.length > 0) {
                                const e = r.statement.toUpperCase().includes("RETURNING") ? "all" : "no",
                                ...
                                if (a.changes.changes < 0) throw new Error("Error in transaction method run ");
                                s += a.changes.changes
                            } else {
                                ...
                                if (e.changes.changes < 0) throw new Error("Error in transaction method execute ");
                                s += e.changes.changes
                            }
                        }
                        s += (await this.sqlite.commitTransaction({
                            database: this.dbName
                        })).changes.changes;
                        const r = {
                            changes: {
            ...
            const i = (0, r.registerPlugin)("CapacitorSQLite", {
                web: () => s.e(57).then(s.bind(s, 8438)).then((e => new e.CapacitorSQLiteWeb)),
